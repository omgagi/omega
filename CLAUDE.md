...
| Crate | Purpose |
|-------|---------|
| `omega-core` | Types, traits, config (Prompts with identity/soul/system + conditional scheduling/projects/meta split, ContextNeeds for gating DB queries), error handling, prompt sanitization |
